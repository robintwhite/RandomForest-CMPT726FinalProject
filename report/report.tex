...
\begin{table}[h]
\caption{Optimal values found for project's Random forest by grid search, Accuracy measure for classification is percent correct, and for regression is mean squared error}
\begin{center}
\begin{tabular}{ccccc}
{\bf Target class} &{\bf Max depth} &{\bf Num features} &{\bf Num of trees}&{\bf Accuracy measure}
\\ \hline \\
GP\_greater\_than\_0         &15		&64 		&71.2\%\\
