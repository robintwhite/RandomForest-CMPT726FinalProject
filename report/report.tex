...
With optimal values shown in ~\ref{opt-table}
...
TODO: Add accuracy comparison, suggest why we see the opposite result for entropy and gini impurity (Gini is slower)
...
\begin{center}
\begin{tabular}{cccc}
{\bf Number of trees} &{\bf Entropy} &{\bf Gini impurity}
\\ \hline \\
...
our implementation             &68.6\%	&$\approx$ 1min 55sec \\
\end{tabular}
\end{center}
\end{table}
